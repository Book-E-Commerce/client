  ...
  return (
    <div>
      <div className="container">
        <p className="cart-title">Showing <b>2 product</b> in cart</p>
        <div className="row">
          <div className="col-9">
            <div className="cartContainer">
              ...
              <div className="row cartContainer--cartItem row no-gutters">
                ...
                <div className="col-5">
                  <p className="mb-0 cartContainer--cartItem--book-title">Manajemen Risiko, Krisis, Dan Bencana Untuk Industri Pariwisata yang Berkelanjutan</p>
